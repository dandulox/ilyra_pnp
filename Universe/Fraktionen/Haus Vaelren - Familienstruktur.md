...
name: Haus Vaelren - Familienstruktur
status: active
scope: universe
tags:
  - universe
...
Diese Datei bündelt die drei politisch relevanten Generationen von [[Haus Vaelren]], ihre Kantonszuordnung und die verdeckten Bruchlinien innerhalb der Herrschaft von [[Velis]].

## Stammbaumübersicht

```text
König Odran Vaelren
└── mit der verstorbenen Königin Maeryn
    ├── Kronprinz Caelen Vaelren - Hauptlinie von Aurenhal
    │   └── Prinz Lucan Vaelren
...
| Linie | Führungsfigur | Kanton | Linienart |
|---|---|---|---|
...
Nach außen erscheint Haus Vaelren als geschlossene Dynastie. Tatsächlich ruht seine Stabilität auf einem alten, fanatischen König, einem nervösen Haupterben, zwei ehrgeizigen Blutlinien und zwei angeheirateten Zweigen, die nie ganz als gleichwertig gelten.
